...
print("\033[1;30;46m{:^50}\033[m".format("PROGRAMA PARA SORTEIO DE NÚMEROS DA LOTOFÁCIL"))
...
for count_01 in range(0, qtd_jogos):
	...
	for count_02 in range(0, 15):
		numero_sorteado = randrange(1, 26, 1)
	...
	lista_de_jogos.append(jogo_criado[:]) # listagem contendo todos os jogos gerados.
	sleep(0.5)
	#jogo_criado.sort()
	if check_color == True :
